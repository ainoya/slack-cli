...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("slack_cli", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "slack_cli" is the name you will use in your source code to
                // import this module (e.g. `@import("slack_cli")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "slack_cli", .module = mod },
            },
        }),
    });
    ...
    // Create a system command to copy the built binary to ~/.local/bin
    ...
    const install_path = b.fmt("{s}/slack-cli", .{install_dir});
    ...
    const cp_cmd = b.addSystemCommand(&[_][]const u8{
        "cp",
        b.getInstallPath(.bin, "slack-cli"),
        install_path,
    });
